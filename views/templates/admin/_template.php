        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li>
                        <a href="<?=url("Admin/Sinodais");?>"><i class="fas fa-fw fa-church mr-2"></i>Sinodais</a>
                    </li>
                    <li>
                        <a href="<?=url("Admin/Diretorias");?>"><i class="fas fa-fw fa-users mr-2"></i>Diretorias</a>
                    </li>
                    <li>
                        <a href="<?=url("Admin/Logout");?>"><i class="fas fa-fw fa-sign-out-alt mr-2"></i>Sair</a>
                    </li>
                </ul>
            </nav>
